  ...
  return (
    <section id="pricing" className="py-20 md:py-32 bg-muted/30">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {POINTS_PACKAGES.map((pkg) => (
            ...
            >
              ...
              <div className="text-center mb-6">
                <h3 className={`text-lg font-semibold mb-2 ${pkg.isBestValue ? 'text-primary-foreground' : 'text-accent'}`}>
                  {pkg.name}
                </h3>
                <div className={`text-3xl font-bold ${pkg.isBestValue ? 'text-primary-foreground' : 'text-accent'}`}>
              ...
              <div className={`text-center mb-6 pb-6 border-b ${pkg.isBestValue ? 'border-primary-foreground/20' : 'border-border'}`}>
                <div className={`text-2xl font-bold ${pkg.isBestValue ? 'text-primary-foreground' : 'text-accent'}`}>
                  ${pkg.price}
                </div>
        ...
        >
          <h3 className="text-xl font-semibold text-accent mb-6">All packages include:</h3>
        ...
        >
          <h3 className="text-xl font-semibold text-accent mb-6 text-center">Tier System</h3>
          <div className="grid grid-cols-2 md:grid-cols-5 gap-4 text-center">
            <div className="p-4 rounded-xl bg-muted/50">
              <div className="text-2xl mb-1">🥉</div>
              <div className="font-semibold text-accent">Bronze</div>
              <div className="text-xs text-muted-foreground">0-500 pts</div>
            </div>
            <div className="p-4 rounded-xl bg-muted/50">
              <div className="text-2xl mb-1">🥈</div>
              <div className="font-semibold text-accent">Silver</div>
              <div className="text-xs text-muted-foreground">501-1,500 pts</div>
            </div>
            <div className="p-4 rounded-xl bg-muted/50">
              <div className="text-2xl mb-1">🥇</div>
              <div className="font-semibold text-accent">Gold</div>
              <div className="text-xs text-muted-foreground">1,501-3,000 pts</div>
            </div>
            <div className="p-4 rounded-xl bg-muted/50">
              <div className="text-2xl mb-1">💎</div>
              <div className="font-semibold text-accent">Platinum</div>
            ...
            <div className="p-4 rounded-xl bg-muted/50 col-span-2 md:col-span-1">
              <div className="text-2xl mb-1">💠</div>
              <div className="font-semibold text-accent">Diamond</div>
